...
Each element of the array may have a different structure for its dataObject field, depending on the value of the type field. For details, check the `Telemetry Data Summary <https://github.com/gamelocker/battlerite-assets/blob/master/telemetry-data-summary.md>`_.
